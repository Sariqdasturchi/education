export const NavmenuList = [
    {id: 1, title: "Asosiy sahifa", link: "/"},
    {id: 2, title: "Ustoz haqida", link: "#about"},
    {id: 3, title: "Ta'lim maqsadi", link: "#education"},
    {id: 4, title: "Ta'lim tarkibi", link: "#education-about"},
    {id: 5, title: "O'quvchilar fikri", link: "#comments"},
]

import icon from "../assets/Frame.png"
export const AboutSkilList = [
    {id: 1, title: "Matematikani o'qitish metodigi", icon: icon},
    {id: 2, title: "15 yildan ortiq o'qituvchilik va tadqiqot faoliyati", icon: icon},
    {id: 3, title: "Xalqaro ta'lim loyihalarida ishtirok etgan", icon: icon},
    {id: 4, title: "Zamonaviy ta'lim texnologiyalari bo'yicha mukofot sohibi", icon: icon},
    {id: 5, title: "Interaktiv testlar va forumlar orqali o'quv jarayonini rivojlantirgan", icon: icon},
]
