...
export default function TestSubmission() {
    ...
    const tests = [
        {
            id: 1,
            question: "35+40 berilgan yig‘indi nechaga teng?",
            options: ["75", "85", "95", "105"],
        },
        {
            id: 2,
            question: "20+50 berilgan yig‘indi nechaga teng?",
            options: ["60", "70", "80", "90"],
        },
        {
            id: 3,
            question: "10+90 berilgan yig‘indi nechaga teng?",
            options: ["80", "90", "100", "110"],
        },
        {
            id: 4,
            question: "25+45 berilgan yig‘indi nechaga teng?",
            options: ["60", "70", "80", "90"],
        },
        {
            id: 5,
            question: "50+30 berilgan yig‘indi nechaga teng?",
                    ...
                    {tests.map((test, index) => (
                        <div key={test.id} className="mb-4 p-4 border rounded-xl">
                            ...
                            {test.options.map((option, optIndex) => (
                                <button
                                    key={optIndex}
                                    onClick={() => selectAnswer(test.id, optIndex)}
                                    className={`w-full text-left p-3 border rounded-xl mb-2 transition duration-300 ${selectedAnswers[test.id] === optIndex
                    ...
                    <div className="p-4 bg-white shadow-lg rounded-xl">
                        ...
                        <div className="grid grid-cols-5 gap-2">
                            {tests.map((test, index) => (
                                <button
                                    key={index}
                                    className={`w-10 h-10 flex items-center justify-center rounded-xl border transition ${selectedAnswers[test.id] !== undefined
