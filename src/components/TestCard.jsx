export const TestCard = ({ number, title, description, status }) => {
    const statusColors = {
    ...
    return (
        <div className="bg-white rounded-2xl shadow-sm p-5 flex justify-between items-center w-[558px] h-[123px]">
